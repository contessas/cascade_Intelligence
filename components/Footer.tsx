    ...
    <footer className="bg-slate-gray text-warm-white/70">
      <div className="container mx-auto px-6 py-8 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left">
        ...
        <div className="text-sm">
            <button type="button" className="bg-transparent border-none hover:text-white transition-colors duration-200">Privacy Policy</button>
            <span className="mx-2">|</span>
            <button type="button" className="bg-transparent border-none hover:text-white transition-colors duration-200">Terms of Service</button>
        </div>
      </div>
    </footer>
  );
