  ...
  return (
    <header className="sticky top-0 z-50 bg-warm-white/80 backdrop-blur-sm shadow-sm">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <a href="#" className="hidden sm:inline-block bg-transparent text-deep-teal font-medium py-2 px-4 border border-deep-teal rounded-full hover:bg-deep-teal hover:text-white transition-colors duration-300">
          Contact Us
        </a>
      </div>
    </header>
